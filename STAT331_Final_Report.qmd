...
ggplot(avg_fertility_gdp, aes(x = year)) +
  ...
  labs(title = "Normalized Average Global Fertility Rate and GDP over Time",
      y=NULL,
      subtitle = "Normalized Avg Global Fertility Rate",
      x = "Year",
      color="Variable")
...
## 2.1 Visualizing Simulations from the Model
