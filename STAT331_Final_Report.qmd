...
>>>>>>> 045550b7ae38ab736ea4c804234aa8f9a21fde1b
...
We will begin by investigating visualization of data on Gross Domestic Product and Fertility rate. Firstly, we investigate the relationship of Gross Domestic Product over time and Fertility rate over time. We average GDP and fertility across all countries per year, to get a single value for average GDP and average Fertility Rate for every year. We also scaled the values of GDP and fertility rate to be between 0 and 1, so that we can compare the two variables with each other, in the following graphic.
